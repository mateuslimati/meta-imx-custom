...
do_install () {
	...
	ln -sf ../init.d/skeleton ${D}${sysconfdir}/rc2.d/S99skeleton
    ln -sf ../init.d/skeleton ${D}${sysconfdir}/rc3.d/S99skeleton
	ln -sf ../init.d/skeleton ${D}${sysconfdir}/rc4.d/S99skeleton
    ln -sf ../init.d/skeleton ${D}${sysconfdir}/rc5.d/S99skeleton
